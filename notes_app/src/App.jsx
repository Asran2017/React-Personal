    ...
    <div className="min-h-screen bg-slate-300 p-6">
      <div className="max-w-7xl mx-auto grid grid-cols-[350px_1fr] gap-6">
        <div className="bg-white rounded-3xl shadow-lg p-6">
          <NoteForm setNoteArray={setNotesArray} noteArray={notesArray} />
        </div>
...
const NoteForm = ({ setNoteArray, noteArray }) => {
    ...
    <>
      <form>
        ...
        <input
          ...
          type="text"
          className="w-full border border-slate-400 px-2 py-2 outline-none focus:ring-2 focus:ring-indigo-500"
...
const NoteItem = ({ note, index, onHandleDelete }) => {
  return (
    <>
      <li className="bg-white border border-slate-300 rounded-2xl p-5 shadow-md hover:shadow-lg transition-all duration-300 ease-in-out flex flex-col gap-4">
        <div className="flex gap-3">
          ...
          <span className="text-lg font-bold italic text-slate-600">
            {note.title}
          </span>
        </div>
        ...
        <div className="flex items-center gap-2">
          <button className="text-blue-500 text-sm px-2 py-1 bg-blue-100 rounded-lg hover:bg-blue-200 transition">
            Edit
          </button>
          <button
